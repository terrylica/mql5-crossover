//+------------------------------------------------------------------+
//|                                       CCI_Neutrality_Simple.mq5 |
//|                          CCI Neutrality Score - Standalone       |
//|                                                                  |
//| Simplified version without CSV logging for initial testing      |
//+------------------------------------------------------------------+
...
#property description "Simplified standalone version - no CSV logging"
...
//--- Set indicator levels
   ...
   IndicatorSetDouble(INDICATOR_LEVELVALUE, 3, InpMinScore * 100.0);
...
//--- Create CCI indicator handle
   ...
   PrintFormat("CCI Neutrality initialized: CCI=%d, W=%d", InpCCILength, InpWindow);
...
//--- Calculate start position using prev_calculated
   int start;
