...
#property description "CCI Neutrality v1.6.0 - MQL5-idiomatic with bar recalculation handling"
...
//--- Rolling window state variables
   ...
   static int    last_processed_bar = -1;  // Track last bar to detect recalculations
   ...
   if(prev_calculated == 0 || start == StartCalcPosition)
     {
      ...
      sum_cci2 = 0.0;
      sum_excess = 0.0;
      last_processed_bar = StartCalcPosition - 1;  // Reset bar tracking
