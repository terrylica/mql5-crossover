//+------------------------------------------------------------------+
//|                            CCI_Neutrality_Visual_SeparateWindow.mq5 |
//|                  Visual version with CCI + Score in separate subwindows |
//+------------------------------------------------------------------+
#property copyright   "Terry Li"
#property link        "https://github.com/terrylica/mql5-crossover"
#property version     "2.10"
#property description "CCI Neutrality - CCI in subwindow 1, Score in subwindow 2"
...
// Plot 1: CCI (Subwindow 1)
#property indicator_label1    "CCI"
#property indicator_type1     DRAW_LINE
#property indicator_color1    clrDodgerBlue
#property indicator_width1    2

// Plot 2: Score (Subwindow 2 - separate scale)
...
//--- Set indicator name
   IndicatorSetString(INDICATOR_SHORTNAME,
                      StringFormat("CCI Neutrality Separate(%d,%d)", InpCCILength, InpWindow));
...
//--- Create CCI indicator handle
   ...
   PrintFormat("CCI Neutrality Visual (Separate Windows) initialized: CCI=%d, W=%d",
...
//--- Release CCI handle
   ...
   PrintFormat("CCI Neutrality Visual (Separate Windows) deinitialized, reason: %d", reason);
  }
   ...
   for(int i = start; i < rates_total && !IsStopped(); i++)
     {
      ...
      //--- Store results
      BufCCI[i] = x_in;
      BufScore[i] = score;  // NOT scaled - pure 0-1 range for separate window
     }
