//+------------------------------------------------------------------+
//|                                CCI_Neutrality_ScoreOnly_Fixed.mq5 |
...
#property description "CCI Neutrality Score - Explicit scale 0.0-0.1"

#property indicator_separate_window
#property indicator_buffers 2  // 2 buffers: Score (visible) + CCI (hidden, for recalc)
...
//--- Set indicator buffers
   ...
   SetIndexBuffer(1, BufCCI, INDICATOR_CALCULATIONS); // Buffer 1: Hidden CCI
